...
Window = {
    Title = "No Title", Footer = "No Footer",
    Position = UDim2.fromOffset(6, 6),
    Size = UDim2.fromOffset(720, 600),
    IconSize = UDim2.fromOffset(30, 30),
    AutoShow = true, Center = true, Resizable = true,
    SearchbarSize = UDim2.fromScale(1, 1),
    GlobalSearch = false, CornerRadius = 4,
    NotifySide = "Right", ShowCustomCursor = true,
    Font = Enum.Font.Code,
    ToggleKeybind = Enum.KeyCode.RightControl,
    ShowMobileButtons = true, MobileButtonsSide = "Left",
    UnlockMouseWhileOpen = true,
    EnableSidebarResize = false, EnableCompacting = true,
    DisableCompactingSnap = false, SidebarCompacted = false,
    MinContainerWidth = 256,
    MinSidebarWidth = 128, SidebarCompactWidth = 48,
    SidebarCollapseThreshold = 0.5, CompactWidthActivation = 128,
},
Dialog = {
    Title = "Dialog", Description = "Description",
    AutoDismiss = true, OutsideClickDismiss = true, FooterButtons = {}
},
Loading = {
    Title = "mspaint", Icon = 95816097006870,
    IconSize = UDim2.fromOffset(30, 30),
    LoadingIcon = CustomImageManager.GetAsset("LoadingIcon"),
    LoadingIconColor = nil, LoadingIconTweenTime = 1,
    CurrentStep = 0, TotalSteps = 10,
    ShowSidebar = false, AutoResizeHeight = false,
    WindowWidth = 450, WindowHeight = 275,
    ContentWidth = 450, SidebarWidth = 250,
},
Toggle = {
    Text = "Toggle", Default = false,
    Callback = function() end, Changed = function() end,
    Risky = false, Disabled = false, Visible = true,
},
Input = {
    Text = "Input", Default = "", Finished = false,
    Numeric = false, ClearTextOnFocus = true, ClearTextOnBlur = false,
    Placeholder = "", AllowEmpty = true, EmptyReset = "---",
    Callback = function() end, Changed = function() end, VerifyValue = nil,
    Disabled = false, Visible = true,
},
Slider = {
    Text = "Slider", Default = 0, Min = 0, Max = 100, Rounding = 0,
    Prefix = "", Suffix = "",
    Callback = function() end, Changed = function() end,
    Disabled = false, Visible = true,
},
Dropdown = {
    Values = {}, DisabledValues = {}, ValueImages = {},
    Multi = false, MaxVisibleDropdownItems = 8,
    Callback = function() end, Changed = function() end,
    Disabled = false, Visible = true,
},
Viewport = {
    Object = nil, Camera = nil, Clone = true,
    AutoFocus = true, Interactive = false, Height = 200, Visible = true,
},
Image = {
    Image = "", Transparency = 0, BackgroundTransparency = 0,
    Color = Color3.new(1, 1, 1), RectOffset = Vector2.zero,
    RectSize = Vector2.zero, ScaleType = Enum.ScaleType.Fit,
    Height = 200, Visible = true,
},
Video = {
    Video = "", Looped = false, Playing = false,
    Volume = 1, Height = 200, Visible = true,
},
UIPassthrough = { Instance = nil, Height = 24, Visible = true },
KeyPicker = {
    Text = "KeyPicker", Default = "None", DefaultModifiers = {},
    Blacklisted = {}, BlacklistedModifiers = {},
    Whitelisted = {}, WhitelistedModifiers = {},
    Mode = "Toggle", Modes = { "Always", "Toggle", "Hold" },
    SyncToggleState = false,
    Callback = function() end, ChangedCallback = function() end,
    Changed = function() end, Clicked = function() end,
},
ColorPicker = {
...
table.sort(PlayerList, function(P1, P2) return P1.Name:lower() < P2.Name:lower() end)
return PlayerList
end
local function GetTeams()
local TeamList = Teams:GetTeams()
table.sort(TeamList, function(T1, T2) return T1.Name:lower() < T2.Name:lower() end)
return TeamList
end
...
for _, ElementInfo in Box.Elements do
    if ElementInfo.Type == "Divider" then
        ElementInfo.Holder.Visible = false; continue
    elseif ElementInfo.SubButton then
        local Visible = false
        if ElementInfo.Text:lower():match(Search) and ElementInfo.Visible then Visible = true
        else ElementInfo.Base.Visible = false end
        if ElementInfo.SubButton.Text:lower():match(Search) and ElementInfo.SubButton.Visible then Visible = true
        else ElementInfo.SubButton.Base.Visible = false end
    ...
    if ElementInfo.Text and ElementInfo.Text:lower():match(Search) and ElementInfo.Visible then
        ElementInfo.Holder.Visible = true; VisibleElements += 1
...
for _, Tabbox in Tab.Tabboxes do
    ...
    for _, SubTab in Tabbox.Tabs do
        ...
        for _, ElementInfo in SubTab.Elements do
            ...
            if ElementInfo.Text and ElementInfo.Text:lower():match(Search) and ElementInfo.Visible then
                ElementInfo.Holder.Visible = true; VisibleElements[SubTab] += 1
            else ElementInfo.Holder.Visible = false end
        end
...
if Trim(Search) == "" then
    Library.Searching = false; Library.LastSearchTab = nil; return
end
...
do
    local _iconMap = {
        -- UI Icons
        ["check"]                = "rbxassetid://97682394690683",
        ["chevron-up"]           = "rbxassetid://97682394690683",
        ["move-diagonal-2"]      = "rbxassetid://97682394690683",
        ["key"]                  = "rbxassetid://97682394690683",
        ["move"]                 = "rbxassetid://97682394690683",
        ["search"]               = "rbxassetid://97682394690683",
        -- Tab Icons
        ["swords"]               = "rbxassetid://119371425382054",
        ["user"]                 = "rbxassetid://119371425382054",
        ["earth"]                = "rbxassetid://119371425382054",
        ["bot"]                  = "rbxassetid://119371425382054",
        ["bolt"]                 = "rbxassetid://119371425382054",
        ["ev-charger"]           = "rbxassetid://119371425382054",
        -- Groupbox Icons
        ["brick-wall-shield"]    = "rbxassetid://119371425382054",
        ["chart-no-axes-gantt"]  = "rbxassetid://119371425382054",
        ["sliders-horizontal"]   = "rbxassetid://119371425382054",
        ["toggle-right"]         = "rbxassetid://119371425382054",
        ["ticket-slash"]         = "rbxassetid://119371425382054",
        ["shield-check"]         = "rbxassetid://119371425382054",
        ["battery-full"]         = "rbxassetid://119371425382054",
        ["youtube"]              = "rbxassetid://119371425382054",
        ["eye"]                  = "rbxassetid://119371425382054",
        ["bitcoin"]              = "rbxassetid://119371425382054",
        ["bot-message-square"]   = "rbxassetid://119371425382054",
        ["settings-2"]           = "rbxassetid://119371425382054",
        ["activity"]             = "rbxassetid://119371425382054",
        ["milestone"]            = "rbxassetid://119371425382054",
        ["biohazard"]            = "rbxassetid://119371425382054",
        ["axe"]                  = "rbxassetid://119371425382054",
        ["circle-dashed"]        = "rbxassetid://119371425382054",
        ["megaphone"]            = "rbxassetid://119371425382054",
        ["wrench"]               = "rbxassetid://119371425382054",
    }

    FetchIcons = true
    Icons = {
        GetAsset = function(name)
            local url = _iconMap[name]
...
for key, value in Table do
    if key ~= "Text" then
        ...
        else ThemeProperties[key] = nil end
    end
    local Assigned = false
    for _ = 1, 4 do
        local Success = pcall(function() Instance[key] = value end)
        if Success then Assigned = true; break end
        task.wait()
    end
end
...
for _ = 1, 20 do
    local Success, Created = pcall(function() return Instance.new(ClassName) end)
    if Success and Created then CreatedInstance = Created; break end
    task.wait()
end
if not CreatedInstance then
    local Success, Created = pcall(function() return Instance.new("Frame") end)
    if Success and Created then CreatedInstance = Created
    else return nil end
end
if Templates[ClassName] then pcall(FillInstance, Templates[ClassName], CreatedInstance) end
pcall(FillInstance, Properties, CreatedInstance)
if Properties["Parent"] and not Properties["ZIndex"] then
    pcall(function() CreatedInstance.ZIndex = Properties.Parent.ZIndex end)
end
return CreatedInstance
end

local function SafeParentUI(GuiInstance, Parent)
if not GuiInstance then return false end
local function ResolveParent()
    if not Parent then return CoreGui end
...
local function TrySetParent(DestinationParent)
    if not DestinationParent then return false end
    local Success = pcall(function() GuiInstance.Parent = DestinationParent end)
    if not Success then return false end
    local HasParent = false
    pcall(function() HasParent = GuiInstance.Parent ~= nil end)
    return HasParent
end
for _ = 1, 6 do
    if TrySetParent(ResolveParent()) then return true end
    task.wait()
end
local PlayerGui
pcall(function() PlayerGui = Library.LocalPlayer:WaitForChild("PlayerGui", 10) end)
for _ = 1, 6 do
    if TrySetParent(PlayerGui) then return true end
    task.wait()
end
return false
end
...
if SkipHiddenUI then return SafeParentUI(UI, CoreGui) end
pcall(protectgui, UI)
return SafeParentUI(UI, gethui)
end

local ScreenGui = New("ScreenGui", {
Name = "Obsidian", DisplayOrder = 998, ResetOnSpawn = false,
})
ParentUI(ScreenGui)
...
Size = UDim2.fromScale(0, 0), AnchorPoint = Vector2.zero,
Text = "", ZIndex = -999, Parent = ScreenGui,
})
...
Cursor = New("Frame", {
    ...
    Visible = false, ZIndex = 11000, Parent = ScreenGui,
})
New("Frame", {
    AnchorPoint = Vector2.new(0.5, 0.5),
...
Params.Text = Text; Params.RichText = true; Params.Font = Font; Params.Size = Size
...
local Result = table.pack(xpcall(Func, function(Error)
    ...
    if Library.NotifyOnError then Library:Notify(Error) end
    return Error
end, ...))
...
Library:GiveSignal(UserInputService.InputChanged:Connect(function(Input)
    if (not IgnoreToggled and not Library.Toggled)
        ...
        or not (ScreenGui and ScreenGui.Parent) then
        Dragging = false
        if Changed and Changed.Connected then Changed:Disconnect(); Changed = nil end
        return
    end
...
Library:GiveSignal(UserInputService.InputChanged:Connect(function(Input)
    ...
    if Dragging and IsHoverInput(Input) then
        local Delta = Input.Position - StartPos
        UI.Size = UDim2.new(
            FrameSize.X.Scale, math.clamp(FrameSize.X.Offset + Delta.X, Library.MinSize.X, math.huge),
            FrameSize.Y.Scale, math.clamp(FrameSize.Y.Offset + Delta.Y, Library.MinSize.Y, math.huge)
        )
...
return New("Frame", {
    ...
    ZIndex = Info.ZIndex or Frame.ZIndex, Parent = Frame,
})
end
...
local Label = New("TextLabel", {
    ...
    Size = UDim2.fromOffset(0, 0), Position = UDim2.fromOffset(6, 6),
    Text = Text, TextSize = 15, ZIndex = 10, Parent = ScreenGui,
})
table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius), Parent = Label }))
New("UIPadding", {
    PaddingBottom = UDim.new(0, 6), PaddingLeft = UDim.new(0, 12),
    PaddingRight = UDim.new(0, 12), PaddingTop = UDim.new(0, 6), Parent = Label,
})
...
local Button = New("TextButton", {
    BackgroundColor3 = "BackgroundColor",
    Position = UDim2.fromOffset(6, 6), TextSize = 16, ZIndex = 10, Parent = ScreenGui,
})
...
function Table:SetText(Text)
    ...
    Button.Text = Text; Button.Size = UDim2.fromOffset(X * 2, Y * 2)
end
Table:SetText(Text)
return Table
end
...
for _ = 1, 4 do
    Holder = New("Frame", {
        AutomaticSize = Enum.AutomaticSize.XY, BackgroundColor3 = "BackgroundColor",
        Position = UDim2.fromOffset(6, 6), Size = UDim2.fromOffset(0, 0), ZIndex = 10, Parent = ScreenGui,
    })
    if Holder then break end
    task.wait()
end
if not Holder then return nil, nil end
local HolderCorner = New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius), Parent = Holder })
if HolderCorner then table.insert(Library.Corners, HolderCorner) end
local HolderScale = New("UIScale", { Parent = Holder })
if HolderScale then table.insert(Library.Scales, HolderScale) end
...
local Label = New("TextLabel", {
    ...
    Text = Name, TextSize = 15, TextXAlignment = Enum.TextXAlignment.Left, Parent = Holder,
})
New("UIPadding", { PaddingLeft = UDim.new(0, 12), PaddingRight = UDim.new(0, 12), Parent = Label })
local Container = New("Frame", {
    BackgroundTransparency = 1, Position = UDim2.fromOffset(0, 35),
    Size = UDim2.new(1, 0, 1, -35), Parent = Holder,
})
New("UIListLayout", { Padding = UDim.new(0, 7), Parent = Container })
New("UIPadding", {
    PaddingBottom = UDim.new(0, 7), PaddingLeft = UDim.new(0, 7),
    PaddingRight = UDim.new(0, 7), PaddingTop = UDim.new(0, 7), Parent = Container,
})
...
local CurrentMenu
function Library:AddContextMenu(Holder, Size, Offset, List, ActiveCallback, IgnoreCornerRadius)
local Menu
...
if List then
    Menu = New("ScrollingFrame", {
        ...
        Visible = false, ZIndex = 10, Parent = ParentGui,
    })
else
    Menu = New("Frame", {
        BackgroundColor3 = "BackgroundColor",
...
if IgnoreCornerRadius ~= true then
    table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius / 2), Parent = Menu }))
end
...
function Table:Open()
    if CurrentMenu == Table then return
...
if IsClickInput(Input, true) then
    ...
    if CurrentMenu and not (
        Library:MouseIsOverFrame(CurrentMenu.Menu, Location)
        or Library:MouseIsOverFrame(CurrentMenu.Holder, Location)
    ) then CurrentMenu:Close() end
end
end))

local TooltipLabel = New("TextLabel", {
AutomaticSize = Enum.AutomaticSize.Y, BackgroundColor3 = "BackgroundColor",
TextSize = 14, TextWrapped = true, Visible = false, ZIndex = 20, Parent = ScreenGui,
})
New("UIPadding", {
PaddingBottom = UDim.new(0, 2), PaddingLeft = UDim.new(0, 4),
PaddingRight = UDim.new(0, 4), PaddingTop = UDim.new(0, 2), Parent = TooltipLabel,
})
...
local X, _ = Library:GetTextBounds(
    TooltipLabel.Text, TooltipLabel.FontFace, TooltipLabel.TextSize,
...
local function DoHover()
    if CurrentHoverInstance == HoverInstance or Library.ActiveDialog
        ...
        or (not TooltipTable.Disabled and typeof(InfoStr) ~= "string") then return end
    ...
    while (Library.Toggled or Library.ActiveLoading) and not Library.ActiveDialog
        and Library:MouseIsOverFrame(HoverInstance, Mouse)
        and not (CurrentMenu and Library:MouseIsOverFrame(CurrentMenu.Menu, Mouse)) do
...
function Funcs:AddKeyPicker(Idx, Info)
    ...
    local KeyPicker = {
        Text = Info.Text, Value = Info.Default, Modifiers = Info.DefaultModifiers,
        ...
        Callback = Info.Callback, ChangedCallback = Info.ChangedCallback,
        Changed = Info.Changed, Clicked = Info.Clicked, Type = "KeyPicker",
    }
    ...
    local GetActiveModifiers = function()
        ...
        for Name, Input in Modifiers do
            if not table.find(AM, Name) and UserInputService:IsKeyDown(Input) then table.insert(AM, Name) end
        end
        return AM
    end
    local AreModifiersHeld = function(Required)
        if not (typeof(Required) == "table" and GetTableSize(Required) > 0) then return true end
        local AM = GetActiveModifiers(); local Holding = true
        for _, Name in Required do if not table.find(AM, Name) then Holding = false; break end end
        return Holding
    end
    ...
    local ConvertToInputModifiers = function(CM)
        local IM = {}
        for _, name in CM do table.insert(IM, Modifiers[name]) end
        return IM
    end
    local VerifyModifiers = function(CM)
        if typeof(CM) ~= "table" then return {} end
        local VM = {}
        for _, name in CM do if Modifiers[name] then table.insert(VM, name) end end
        return VM
    end
    ...
    local Picker = New("TextButton", {
        BackgroundColor3 = "MainColor", Size = UDim2.fromOffset(PickerWidth, 18),
        Text = GetKeyPickerDisplayText(KeyPicker.Value), TextSize = 14, Parent = ToggleLabel,
    })
    New("UIStroke", { Color = "OutlineColor", Parent = Picker })
    table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius / 2), Parent = Picker }))
    local KeybindsToggle = { Normal = KeyPicker.Mode ~= "Toggle" }
    do
        local Holder = New("TextButton", {
            BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 16),
            Text = "", Visible = not Info.NoUI, Parent = Library.KeybindContainer,
        })
        local Label = New("TextLabel", {
            AutomaticSize = Enum.AutomaticSize.X, BackgroundTransparency = 1,
            Size = UDim2.fromScale(0, 1), Text = "", TextSize = 14, TextTransparency = 0.5, Parent = Holder,
        })
        local Checkbox = New("Frame", {
            AnchorPoint = Vector2.new(0, 0.5), BackgroundColor3 = "MainColor",
            Position = UDim2.fromScale(0, 0.5), Size = UDim2.fromOffset(14, 14),
            SizeConstraint = Enum.SizeConstraint.RelativeYY, Parent = Holder,
        })
        ...
        local CheckImage = New("ImageLabel", {
            ...
            ImageTransparency = 1,
            Position = UDim2.fromOffset(2, 2), Size = UDim2.new(1, -4, 1, -4), Parent = Checkbox,
        })
        ...
        KeybindsToggle.Holder = Holder; KeybindsToggle.Label = Label
        KeybindsToggle.Checkbox = Checkbox; KeybindsToggle.Loaded = true
    ...
    for _, Mode in Info.Modes do
        local ModeButton = {}
        local Button = New("TextButton", {
            BackgroundColor3 = "MainColor", BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 21), Text = Mode,
            TextSize = 14, TextTransparency = 0.5, Parent = MenuTable.Menu,
        })
        function ModeButton:Select()
            for _, B in ModeButtons do B:Deselect() end
            KeyPicker.Mode = Mode
        ...
        function ModeButton:Deselect()
            KeyPicker.Mode = nil
            Button.BackgroundTransparency = 1; Button.TextTransparency = 0.5
        end
    ...
    function KeyPicker:Display(PickerText)
        ...
        Picker.Text = DisplayText; Picker.Size = UDim2.fromOffset(math.max(18, X + 9), (Y + 4))
    end
    function KeyPicker:Update()
        KeyPicker:Display()
        if Info.NoUI then return end
        if KeyPicker.Mode == "Toggle" and ParentObj.Type == "Toggle" and ParentObj.Disabled then
            KeybindsToggle:SetVisibility(false); return
        end
    ...
    function KeyPicker:SetValue(Data)
        ...
        if Key == nil then KeyPicker.Value = "None"
        elseif IsKeyValid then KeyPicker.Value = Key
        else KeyPicker.Value = "Unknown" end
        if ParentObj.Type == "Toggle" and KeyPicker.Mode == "Toggle" then
            ...
            KeyPicker.Toggled = ParentObj.Value; Info.Modes = {"Toggle","Hold"}
        end
    ...
    Picker.MouseButton1Click:Connect(function()
        ...
        Picking = true; Picker.Text = "..."; Picker.Size = UDim2.fromOffset(29, 18)
        local Input; local ActiveModifiers = {}
        local GetInput = nil; GetInput = function()
            ...
            local IsMod = IsModifierInput(Input); local KeyName
            if SpecialKeysInput[Input.UserInputType] ~= nil then KeyName = SpecialKeysInput[Input.UserInputType]
            elseif Input.UserInputType == Enum.UserInputType.Keyboard then
        ...
        repeat
            task.wait()
            Picker.Text = "..."; Picker.Size = UDim2.fromOffset(29, 18)
            if GetInput() then Picking = false; KeyPicker:Update(); return end
                ...
                repeat
                    ...
                    if UserInputService:IsKeyDown(Input.KeyCode) then
                        ...
                        if UserInputService:IsKeyDown(Input.KeyCode) then
                            ...
                            if GetInput() then StopLoop = true; break end
                            if Input.KeyCode == Enum.KeyCode.Escape then break end
                            if not IsModifierInput(Input) then break end
                        else
                            if not table.find(ActiveModifiers, ModifiersInput[Input.KeyCode]) then break end
                        end
                    end
                until false
                if StopLoop then Picking = false; KeyPicker:Update(); return end
            end
            break
        until false
        local Key = "Unknown"
        if SpecialKeysInput[Input.UserInputType] ~= nil then Key = SpecialKeysInput[Input.UserInputType]
        elseif Input.UserInputType == Enum.UserInputType.Keyboard then
            Key = Input.KeyCode == Enum.KeyCode.Escape and "None" or Input.KeyCode.Name
        end
        ActiveModifiers = if Input.KeyCode == Enum.KeyCode.Escape or Key == "Unknown" then {} else ActiveModifiers
        KeyPicker.Toggled = false; KeyPicker:SetValue({Key, KeyPicker.Mode, ActiveModifiers})
    ...
    Library:GiveSignal(UserInputService.InputBegan:Connect(function(Input)
        if Library.Unloaded then return end
        if KeyPicker.Mode == "Always" or KeyPicker.Value == "Unknown" or KeyPicker.Value == "None"
            or Picking or UserInputService:GetFocusedTextBox() then return end
        local Key = KeyPicker.Value
    ...
    Library:GiveSignal(UserInputService.InputEnded:Connect(function()
        if Library.Unloaded then return end
        if KeyPicker.Value == "Unknown" or KeyPicker.Value == "None"
            or Picking or UserInputService:GetFocusedTextBox() then return end
        KeyPicker:Update()
    end))
    KeyPicker:Update()
...
function Funcs:AddColorPicker(Idx, Info)
    ...
    local ColorPicker = {
        ...
        Title = Info.Title, Callback = Info.Callback, Changed = Info.Changed, Type = "ColorPicker",
    }
    ...
    local HolderTransparency = New("ImageLabel", {
        ...
        TileSize = UDim2.fromOffset(9, 9), Parent = Holder,
    })
    ...
    local ColorMenu = Library:AddContextMenu(Holder,
        ...
        function() return {0.5, Holder.AbsoluteSize.Y + 1.5} end, 1)
    ColorMenu.List.Padding = UDim.new(0, 8); ColorPicker.ColorMenu = ColorMenu
    New("UIPadding", {
        PaddingBottom = UDim.new(0, 6), PaddingLeft = UDim.new(0, 6),
        PaddingRight = UDim.new(0, 6), PaddingTop = UDim.new(0, 6), Parent = ColorMenu.Menu,
    })
    if typeof(ColorPicker.Title) == "string" then
        New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 8), Text = ColorPicker.Title, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, Parent = ColorMenu.Menu })
    end
    ...
    New("UIStroke", { Color = "DarkColor", Parent = SatVibCursor })
    ...
    local HueCursor = New("Frame", {
        AnchorPoint = Vector2.new(0.5, 0.5), BackgroundColor3 = "WhiteColor",
        BorderColor3 = "DarkColor", BorderSizePixel = 1,
        Position = UDim2.fromScale(0.5, ColorPicker.Hue), Size = UDim2.new(1, 2, 0, 1), Parent = HueSelector,
    })
    ...
    do
        local function CreateButton(Text, Func)
            ...
            Button.MouseButton1Click:Connect(function() Library:SafeCallback(Func); ContextMenu:Close() end)
        end
        ...
        if setclipboard then
            CreateButton("Copy Hex", function() setclipboard(tostring(ColorPicker.Value:ToHex())) end)
            CreateButton("Copy RGB", function() setclipboard(table.concat({math.floor(ColorPicker.Value.R*255), math.floor(ColorPicker.Value.G*255), math.floor(ColorPicker.Value.B*255)}, ", ")) end)
        end
    end
    ...
    function ColorPicker:SetValue(HSV, Transparency)
        ...
        ColorPicker:SetHSVFromRGB(Color); ColorPicker:Update()
    end
    ...
    SatVipMap.InputBegan:Connect(function(Input)
        while IsDragInput(Input) do
            local MinX = SatVipMap.AbsolutePosition.X; local MaxX = MinX + SatVipMap.AbsoluteSize.X
            local LocationX = math.clamp(Mouse.X, MinX, MaxX)
            local MinY = SatVipMap.AbsolutePosition.Y; local MaxY = MinY + SatVipMap.AbsoluteSize.Y
    ...
    if TransparencySelector then
        TransparencySelector.InputBegan:Connect(function(Input)
            while IsDragInput(Input) do
                local Min = TransparencySelector.AbsolutePosition.Y; local Max = TransparencySelector.AbsolutePosition.Y + TransparencySelector.AbsoluteSize.Y
                local Location = math.clamp(Mouse.Y, Min, Max)
                local OldT = ColorPicker.Transparency
                ColorPicker.Transparency = (Location - Min) / (Max - Min)
                if ColorPicker.Transparency ~= OldT then ColorPicker:Update() end
                RunService.RenderStepped:Wait()
            end
        end)
    end
...
function Funcs:AddDivider(...)
    ...
    local Text; local MarginTop = 0; local MarginBottom = 0
    if typeof(Params) == "table" then
        Text = Params.Text; MarginTop = Params.MarginTop or Params.Margin or 0; MarginBottom = Params.MarginBottom or Params.Margin or 0
    ...
    Groupbox:Resize()
    local Divider = { Holder = Holder, Text = Text, MarginTop = MarginTop, MarginBottom = MarginBottom, Type = "Divider" }
...
function Funcs:AddLabel(...)
    ...
    if typeof(First) == "table" or typeof(Second) == "table" then
        ...
        Data.Text = Params.Text or ""; Data.DoesWrap = Params.DoesWrap or false
        Data.Size = Params.Size or 14; Data.Visible = Params.Visible or true
        Data.Idx = typeof(Second) == "table" and First or nil
    else
        Data.Text = First or ""; Data.DoesWrap = Second or false
        Data.Size = 14; Data.Visible = true; Data.Idx = select(3, ...) or nil
    end
    local Groupbox = self; local Container = Groupbox.Container
    local Label = { Text = Data.Text, DoesWrap = Data.DoesWrap, Addons = Addons, Visible = Data.Visible, Type = "Label" }
    local TextLabel = New("TextLabel", {
        BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 18),
        Text = Label.Text, TextSize = Data.Size, TextWrapped = Label.DoesWrap,
        TextXAlignment = Groupbox.IsKeyTab and Enum.TextXAlignment.Center or Enum.TextXAlignment.Left, Parent = Container,
    })
    function Label:SetVisible(Visible) Label.Visible = Visible; TextLabel.Visible = Label.Visible; Groupbox:Resize() end
    function Label:SetText(Text)
        Label.Text = Text; TextLabel.Text = Text
    ...
    if Label.DoesWrap then
        ...
        TextLabel:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
            ...
            local _, Y = Library:GetTextBounds(Label.Text, TextLabel.FontFace, TextLabel.TextSize, TextLabel.AbsoluteSize.X)
            TextLabel.Size = UDim2.new(1, 0, 0, Y + 4); Last = TextLabel.AbsoluteSize; Groupbox:Resize()
        end)
    else
...
function Funcs:AddButton(...)
    local function GetInfo(...)
        ...
        if typeof(First) == "table" or typeof(Second) == "table" then
            local Params = typeof(First) == "table" and First or Second
            Info.Text = Params.Text or ""; Info.Func = Params.Func or Params.Callback or function() end
            Info.DoubleClick = Params.DoubleClick; Info.Tooltip = Params.Tooltip
            Info.DisabledTooltip = Params.DisabledTooltip; Info.Risky = Params.Risky or false
            Info.Disabled = Params.Disabled or false; Info.Visible = Params.Visible or true
            Info.Idx = typeof(Second) == "table" and First or nil
        else
            Info.Text = First or ""; Info.Func = Second or function() end; Info.DoubleClick = false
            Info.Tooltip = nil; Info.DisabledTooltip = nil; Info.Risky = false
            Info.Disabled = false; Info.Visible = true; Info.Idx = select(3, ...) or nil
        end
        return Info
    end
    local Info = GetInfo(...)
    local Groupbox = self; local Container = Groupbox.Container
    local Button = {
        Text = Info.Text, Func = Info.Func, DoubleClick = Info.DoubleClick,
        Tooltip = Info.Tooltip, DisabledTooltip = Info.DisabledTooltip, TooltipTable = nil,
        Risky = Info.Risky, Disabled = Info.Disabled, Visible = Info.Visible,
        Tween = nil, Type = "Button",
    }
    ...
    local function CreateButton(Button)
        local Base = New("TextButton", {
            Active = not Button.Disabled, BackgroundColor3 = Button.Disabled and "BackgroundColor" or "MainColor",
            Size = UDim2.fromScale(1, 1), Text = Button.Text, TextSize = 14,
            TextTransparency = 0.4, Visible = Button.Visible, Parent = Holder,
        })
    ...
    local function InitEvents(Button)
        Button.Base.MouseEnter:Connect(function()
            ...
            Button.Tween = TweenService:Create(Button.Base, Library.TweenInfo, {TextTransparency = 0}); Button.Tween:Play()
        end)
        Button.Base.MouseLeave:Connect(function()
            if Button.Disabled then return end
            Button.Tween = TweenService:Create(Button.Base, Library.TweenInfo, {TextTransparency = 0.4}); Button.Tween:Play()
        end)
    ...
    function Button:AddButton(...)
        ...
        function SubButton:SetDisabled(Disabled)
            ...
            SubButton.Base.Active = not SubButton.Disabled; SubButton:UpdateColors()
        end
        function SubButton:SetVisible(Visible)
            SubButton.Visible = Visible; SubButton.Base.Visible = SubButton.Visible; Groupbox:Resize()
        end
    ...
    function Button:SetDisabled(Disabled)
        ...
        Button.Base.Active = not Button.Disabled; Button:UpdateColors()
    end
    ...
    Button:UpdateColors(); Groupbox:Resize()
    Button.Holder = Holder; table.insert(Groupbox.Elements, Button)
...
function Funcs:AddToggle(Idx, Info)
    ...
    local Groupbox = self; local Container = Groupbox.Container
    local Toggle = {
        Text = Info.Text, Value = Info.Default,
        Tooltip = Info.Tooltip, DisabledTooltip = Info.DisabledTooltip, TooltipTable = nil,
        Callback = Info.Callback, Changed = Info.Changed,
        Risky = Info.Risky, Disabled = Info.Disabled, Visible = Info.Visible,
        Addons = {}, Variant = "Switch", Type = "Toggle",
    }
    ...
    Toggle.TextLabel = Label; Toggle.Container = Container
    setmetatable(Toggle, BaseAddons)
    if not Toggle.AutoKeyPicker then
        Toggle.AutoKeyPicker = Toggle:AddKeyPicker(Idx .. "Key", {
            Text = Toggle.Text, Default = Info.Keybind or "None",
            Mode = "Toggle", SyncToggleState = Info.Keybind ~= nil and Info.Keybind ~= "None",
        })
    end
    Toggle.Holder = Button; table.insert(Groupbox.Elements, Toggle)
    Toggle.Default = Toggle.Value; Toggles[Idx] = Toggle
    return Toggle
end
...
function Funcs:AddCheckbox(Idx, Info)
    ...
    local Toggle = {
        ...
        Callback = Info.Callback, Changed = Info.Changed,
        Risky = Info.Risky, Disabled = Info.Disabled, Visible = Info.Visible,
        Addons = {}, Variant = "Checkbox", Type = "Toggle",
    }
    local Button = New("TextButton", { Active = not Toggle.Disabled, BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 18), Text = "", Visible = Toggle.Visible, Parent = Container })
    ...
    function Toggle:Display()
        ...
        if Toggle.Disabled then
            ...
            Library.Registry[Checkbox].BackgroundColor3 = "BackgroundColor"; return
        end
        TweenService:Create(Label, Library.TweenInfo, {TextTransparency = Toggle.Value and 0 or 0.4}):Play()
...
function Funcs:AddInput(Idx, Info)
    ...
    local Groupbox = self; local Container = Groupbox.Container
    local Input = {
        Text = Info.Text, Value = Info.Default, Finished = Info.Finished,
        Numeric = Info.Numeric, ClearTextOnFocus = Info.ClearTextOnFocus, ClearTextOnBlur = Info.ClearTextOnBlur,
        Placeholder = Info.Placeholder, AllowEmpty = Info.AllowEmpty, EmptyReset = Info.EmptyReset,
        Tooltip = Info.Tooltip, DisabledTooltip = Info.DisabledTooltip, TooltipTable = nil,
        Callback = Info.Callback, Changed = Info.Changed, VerifyValue = Info.VerifyValue,
        Disabled = Info.Disabled, Visible = Info.Visible, Type = "Input",
    }
    ...
    local Box = New("TextBox", {
        AnchorPoint = Vector2.new(0, 1), BackgroundColor3 = "MainColor",
        ClearTextOnFocus = not Input.Disabled and Input.ClearTextOnFocus,
        PlaceholderText = Input.Placeholder, Position = UDim2.fromScale(0, 1),
        Size = UDim2.new(1, 0, 0, 21), Text = Input.Value,
        TextEditable = not Input.Disabled, TextScaled = true, TextXAlignment = Enum.TextXAlignment.Left, Parent = Holder,
    })
    ...
    function Input:SetDisabled(Disabled)
        ...
        Box.TextEditable = not Input.Disabled; Input:UpdateColors()
    end
    function Input:SetVisible(Visible) Input.Visible = Visible; Holder.Visible = Input.Visible; Groupbox:Resize() end
    function Input:SetText(Text) Input.Text = Text; Label.Text = Text end
    if Input.Finished then
        Box.FocusLost:Connect(function(Enter)
            if not Enter then if Input.ClearTextOnBlur then Box.Text = Input.Value end; return end
...
function Funcs:AddSlider(Idx, Info)
    ...
    local Groupbox = self; local Container = Groupbox.Container
    local Slider = {
        Text = Info.Text, Value = Info.Default, Min = Info.Min, Max = Info.Max,
        Prefix = Info.Prefix, Suffix = Info.Suffix, Compact = Info.Compact,
        Rounding = Info.Rounding, HideMax = Info.HideMax,
        Tooltip = Info.Tooltip, DisabledTooltip = Info.DisabledTooltip, TooltipTable = nil,
        Callback = Info.Callback, Changed = Info.Changed,
        Disabled = Info.Disabled, Visible = Info.Visible, Type = "Slider",
    }
    ...
    if not Info.Compact then
        SliderLabel = New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 14), Text = Slider.Text, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, Parent = Holder })
    end
    ...
    function Slider:Display()
        ...
        if CustomDisplayText then DisplayLabel.Text = tostring(CustomDisplayText)
            ...
            if Info.Compact then DisplayLabel.Text = string.format("%s: %s%s%s", Slider.Text, Slider.Prefix, Slider.Value, Slider.Suffix)
    ...
    function Slider:SetMax(Value)
        assert(Value > Slider.Min, "Max value cannot be less than min.")
        Slider:SetValue(math.clamp(Slider.Value, Slider.Min, Value)); Slider.Max = Value; Slider:Display()
    end
    function Slider:SetMin(Value)
        assert(Value < Slider.Max, "Min value cannot be greater than max.")
        Slider:SetValue(math.clamp(Slider.Value, Value, Slider.Max)); Slider.Min = Value; Slider:Display()
    end
    ...
    Slider:UpdateColors(); Slider:Display(); Groupbox:Resize()
    Slider.Holder = Holder; table.insert(Groupbox.Elements, Slider)
    Slider.Default = Slider.Value; Options[Idx] = Slider
    return Slider
end
...
function Funcs:AddDropdown(Idx, Info)
    ...
    local Dropdown = {
        ...
        Value = Info.Multi and {} or nil, Values = Info.Values,
        DisabledValues = Info.DisabledValues, ValueImages = Info.ValueImages,
        Multi = Info.Multi, SpecialType = Info.SpecialType,
        ExcludeLocalPlayer = Info.ExcludeLocalPlayer, EnablePlayerImages = Info.EnablePlayerImages,
        Tooltip = Info.Tooltip, DisabledTooltip = Info.DisabledTooltip, TooltipTable = nil,
        Callback = Info.Callback, Changed = Info.Changed,
        Disabled = Info.Disabled, Visible = Info.Visible, Type = "Dropdown",
    }
    ...
    if Library.CornerRadiusDropdown == true then
        table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius / 2), Parent = DisplayContainer }))
    end
    ...
    local ArrowImage = New("ImageLabel", {
        ...
        Position = UDim2.fromScale(1, 0.5), Size = UDim2.fromOffset(16, 16), Parent = DisplayContainer,
    })
    local SearchBox
    ...
    local MenuTable = Library:AddContextMenu(DisplayContainer,
        function() return UDim2.fromOffset((DisplayContainer.AbsoluteSize.X / Library.DPIScale) + 1, 0) end,
    ...
    function Dropdown:RecalculateListSize(Count)
        ...
        MenuTable:SetSize(function() return UDim2.fromOffset((DisplayContainer.AbsoluteSize.X / Library.DPIScale) + 1, Y) end)
    end
    ...
    function Dropdown:Display()
        ...
        else DisplayImage.Image = ""; DisplayImage.ImageTransparency = 1 end
    ...
    function Dropdown:BuildDropdownList()
        ...
        for Button, _ in DropButtons do Button.Parent:Destroy() end
        table.clear(DropButtons)
        local Count = 0
        for _, Value in Values do
            ...
            local Table = {}; local ValueImage = GetValueImage(Value)
            local Container2 = New("Frame", { BackgroundColor3 = "MainColor", BackgroundTransparency = 1, LayoutOrder = IsDisabled and 1 or 0, Size = UDim2.new(1, 0, 0, 21), Parent = MenuTable.Menu })
            local Image = ValueImage and New("ImageLabel", { BackgroundTransparency = 1, Image = ValueImage.Url, ImageRectOffset = ValueImage.ImageRectOffset, ImageRectSize = ValueImage.ImageRectSize, ImageTransparency = 0.5, Size = UDim2.fromOffset(16, 16), Position = UDim2.fromOffset(4, 3), Parent = Container2 })
            local DropBtn = New("TextButton", { BackgroundTransparency = 1, Size = ValueImage and UDim2.new(1, -18, 0, 21) or UDim2.new(1, 0, 0, 21), Position = ValueImage and UDim2.fromOffset(18, 0) or UDim2.fromOffset(0, 0), Text = FormattedValue, TextSize = 14, TextTransparency = 0.5, TextXAlignment = Enum.TextXAlignment.Left, Parent = Container2 })
            New("UIPadding", { PaddingLeft = UDim.new(0, 7), PaddingRight = UDim.new(0, 7), Parent = DropBtn })
            local Selected
            if Info.Multi then Selected = Dropdown.Value[Value] else Selected = Dropdown.Value == Value end
            function Table:UpdateButton()
                if Info.Multi then Selected = Dropdown.Value[Value] else Selected = Dropdown.Value == Value end
                Container2.BackgroundTransparency = Selected and 0 or 1
                DropBtn.TextTransparency = IsDisabled and 0.8 or Selected and 0 or 0.5
            ...
            if not IsDisabled then
                DropBtn.MouseButton1Click:Connect(function()
                    ...
                    if not (Dropdown:GetActiveValues() == 1 and not Try and not Info.AllowNull) then
                        Selected = Try
                        if Info.Multi then Dropdown.Value[Value] = Selected and true or nil
                        else Dropdown.Value = Selected and Value or nil end
                        for _, OtherButton in DropButtons do OtherButton:UpdateButton() end
                    end
    ...
    function Dropdown:SetValue(Value)
        if Info.Multi then
            ...
            if table.find(Dropdown.Values, Value) then Dropdown.Value = Value
            elseif not Value then Dropdown.Value = nil end
        end
        Dropdown:Display()
        for _, Button in DropButtons do Button:UpdateButton() end
    ...
    function Dropdown:AddValues(Values)
        ...
        elseif typeof(Values) == "string" then table.insert(Dropdown.Values, Values)
        else return end
    ...
    function Dropdown:AddDisabledValues(DisabledValues)
        ...
        elseif typeof(DisabledValues) == "string" then table.insert(Dropdown.DisabledValues, DisabledValues)
        else return end
        Dropdown:BuildDropdownList()
    end
    function Dropdown:SetValueImages(ValueImages)
        if typeof(ValueImages) ~= "table" then return end
        Dropdown.ValueImages = ValueImages; Dropdown:BuildDropdownList()
    end
    ...
    function Dropdown:SetDisabled(Disabled)
        ...
        MenuTable:Close(); DisplayButton.Active = not Dropdown.Disabled; Dropdown:UpdateColors()
    end
    function Dropdown:SetVisible(Visible) Dropdown.Visible = Visible; Holder.Visible = Dropdown.Visible; Groupbox:Resize() end
    function Dropdown:SetText(Text)
        Dropdown.Text = Text; Holder.Size = UDim2.new(1, 0, 0, Text and 39 or 21)
        Label.Text = Text and Text or ""; Label.Visible = not not Text
    end
    local ToggleDropdown = function()
        if Dropdown.Disabled then return end; MenuTable:Toggle()
    end
    DisplayContainer.MouseButton1Click:Connect(ToggleDropdown)
    DisplayButton.MouseButton1Click:Connect(ToggleDropdown)
    if SearchBox then SearchBox:GetPropertyChangedSignal("Text"):Connect(Dropdown.BuildDropdownList) end
    local Defaults = {}
    ...
    Dropdown:UpdateColors(); Dropdown:Display(); Dropdown:BuildDropdownList(); Groupbox:Resize()
    Dropdown.Holder = Holder; table.insert(Groupbox.Elements, Dropdown)
    Dropdown.Default = Defaults; Dropdown.DefaultValues = Dropdown.Values
...
function Funcs:AddDependencyBox()
    ...
    local Depbox = {
        Visible = false, Dependencies = {},
        Holder = DepboxContainer, Container = DepboxContainer,
        Elements = {}, DependencyBoxes = {},
    }
    ...
    function Depbox:Update(CancelSearch)
        for _, Dependency in Depbox.Dependencies do
            ...
            if Element.Type == "Toggle" and Element.Value ~= Value then
                DepboxContainer.Visible = false; Depbox.Visible = false; return
    ...
    DepboxList:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        if not Depbox.Visible then return end; Depbox:Resize()
    end)
...
function Funcs:AddDependencyGroupbox()
    ...
    local DepGroupboxContainer = New("Frame", { BackgroundColor3 = "BackgroundColor", Size = UDim2.fromScale(1, 0), Visible = false, Parent = BoxHolder })
    table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius), Parent = DepGroupboxContainer }))
    ...
    local DepGroupbox = {
        Visible = false, Dependencies = {},
        BoxHolder = BoxHolder, Holder = DepGroupboxContainer, Container = DepGroupboxContainer,
        Tab = Tab, Elements = {}, DependencyBoxes = {},
    }
    ...
    function DepGroupbox:Update(CancelSearch)
        for _, Dependency in DepGroupbox.Dependencies do
            local Element = Dependency[1]; local Value = Dependency[2]
            if Element.Type == "Toggle" and Element.Value ~= Value then
                DepGroupboxContainer.Visible = false; DepGroupbox.Visible = false; return
            elseif Element.Type == "Dropdown" then
                if typeof(Element.Value) == "table" then
    ...
    function DepGroupbox:SetupDependencies(Dependencies)
        for _, Dependency in Dependencies do
            assert(typeof(Dependency) == "table"); assert(Dependency[1] ~= nil); assert(Dependency[2] ~= nil)
        end
        DepGroupbox.Dependencies = Dependencies; DepGroupbox:Update()
    end
...
local function ApplyNotifySide()
    if not NotificationArea or not NotificationList then return false end
...
if not Success then task.defer(function() pcall(ApplyNotifySide) end) end
end

function Library:Notify(...)
local Data = {}; local Info = select(1, ...)
if typeof(Info) == "table" then
    Data.Title = tostring(Info.Title); Data.Description = tostring(Info.Description)
    Data.Time = Info.Time or 5; Data.SoundId = Info.SoundId; Data.Steps = Info.Steps
    Data.Persist = Info.Persist; Data.Icon = Info.Icon; Data.BigIcon = Info.BigIcon; Data.IconColor = Info.IconColor
else
    Data.Description = tostring(Info); Data.Time = select(2, ...) or 5; Data.SoundId = select(3, ...)
end
Data.Destroyed = false
local DeletedInstance = false; local DeleteConnection = nil
if typeof(Data.Time) == "Instance" then
    DeleteConnection = Data.Time.Destroying:Connect(function()
        DeletedInstance = true; DeleteConnection:Disconnect(); DeleteConnection = nil
    end)
end
...
local Holder = New("Frame", {
    AutomaticSize = Enum.AutomaticSize.Y, BackgroundColor3 = "MainColor",
...
if Data.BigIcon then
    ...
    if ParsedIcon then
        BigIconLabel = New("ImageLabel", { BackgroundTransparency = 1, Size = UDim2.fromOffset(24, 24), Image = ParsedIcon.Url, ImageColor3 = Data.IconColor or "AccentColor", ImageRectOffset = ParsedIcon.ImageRectOffset, ImageRectSize = ParsedIcon.ImageRectSize, Parent = ContentContainer })
    end
end
...
if Data.Title then TitleContainer = New("Frame", { BackgroundTransparency = 1, Size = UDim2.fromScale(0, 0), Parent = TextContainer }) end
local IconLabel
if Data.Icon and TitleContainer then
    local ParsedIcon = Library:GetCustomIcon(Data.Icon)
    if ParsedIcon then
        IconLabel = New("ImageLabel", { BackgroundTransparency = 1, AnchorPoint = Vector2.new(0, 0.5), Position = UDim2.new(0, 0, 0.5, 1), Size = UDim2.fromOffset(15, 15), Image = ParsedIcon.Url, ImageColor3 = Data.IconColor or "FontColor", ImageRectOffset = ParsedIcon.ImageRectOffset, ImageRectSize = ParsedIcon.ImageRectSize, Parent = TitleContainer })
    end
end
local Title; local Desc; local TitleX = 0; local DescX = 0; local TimerFill
if Data.Title then
    Title = New("TextLabel", { AutomaticSize = Enum.AutomaticSize.None, BackgroundTransparency = 1, AnchorPoint = Vector2.new(0, 0.5), Position = UDim2.new(0, (Data.Icon and 21 or 0), 0.5, 0), Size = UDim2.fromScale(0, 0), Text = Data.Title, TextSize = 15, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Center, TextWrapped = true, Parent = TitleContainer })
end
if Data.Description then
    Desc = New("TextLabel", { AutomaticSize = Enum.AutomaticSize.None, BackgroundTransparency = 1, Size = UDim2.fromScale(0, 0), Text = Data.Description, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, TextWrapped = true, Parent = TextContainer })
end
function Data:Resize()
    ...
    if Title then
        ...
        Title.Size = UDim2.fromOffset(X, Y); TitleX = X + IconWidth
    ...
    if Desc then
        ...
        Desc.Size = UDim2.fromOffset(X, Y); DescX = X
    end
...
function Data:Destroy()
    ...
    task.delay(Library.NotifyTweenInfo.Time, function()
        Library.Notifications[FakeBackground] = nil; FakeBackground:Destroy()
    end)
end
Data:Resize()
...
task.delay(Library.NotifyTweenInfo.Time, function()
    ...
    elseif typeof(Data.Time) == "Instance" then
        ...
        TweenService:Create(TimerFill, TweenInfo.new(Data.Time, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), { Size = UDim2.fromScale(0, 1) }):Play()
        task.wait(Data.Time)
    end
...
pcall(function() Library:SetNotifySide(WindowInfo.NotifySide) end)
Library.ShowCustomCursor = WindowInfo.ShowCustomCursor
Library.Scheme.Font = WindowInfo.Font
Library.ToggleKeybind = WindowInfo.ToggleKeybind
Library.GlobalSearch = WindowInfo.GlobalSearch
local IsDefaultSearchbarSize = WindowInfo.SearchbarSize == UDim2.fromScale(1, 1)
local MainFrame, DividerLine, TitleHolder, WindowTitle, WindowIcon
local RightWrapper, SearchBox, CurrentTabInfo, CurrentTabLabel, CurrentTabDescription
local ResizeButton, Tabs, Container, BackgroundImage, BottomBackground, FooterLabel
...
do
    ...
    MainFrame = New("TextButton", {
        ...
        Name = "Main", Text = "", Position = WindowInfo.Position, Size = WindowInfo.Size,
    ...
    DividerLine = New("Frame", { BackgroundColor3 = "OutlineColor", Position = UDim2.fromOffset(InitialLeftWidth, 0), Size = UDim2.new(0, 1, 1, -21), Parent = MainFrame })
    if WindowInfo.BackgroundImage then
        BackgroundImage = New("ImageLabel", { Image = WindowInfo.BackgroundImage, Position = UDim2.fromScale(0, 0), Size = UDim2.fromScale(1, 1), ScaleType = Enum.ScaleType.Stretch, ZIndex = 999, BackgroundTransparency = 1, ImageTransparency = 0.75, Parent = MainFrame })
    ...
    if WindowInfo.Icon then
        ...
        if Icon then
            WindowIcon = New("ImageLabel", { Image = Icon.Url, ImageRectOffset = Icon.ImageRectOffset, ImageRectSize = Icon.ImageRectSize, Size = WindowInfo.IconSize, Parent = TitleHolder })
        else
            WindowIcon = New("TextLabel", { BackgroundTransparency = 1, Size = WindowInfo.IconSize, Text = WindowInfo.Title:sub(1, 1), TextScaled = true, Visible = false, Parent = TitleHolder })
        end
    else
        WindowIcon = New("TextLabel", { BackgroundTransparency = 1, Size = WindowInfo.IconSize, Text = WindowInfo.Title:sub(1, 1), TextScaled = true, Visible = false, Parent = TitleHolder })
    end
    ...
    WindowTitle = New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.new(0, X, 1, 0), Text = WindowInfo.Title, TextSize = 20, Parent = TitleHolder })
    RightWrapper = New("Frame", { AnchorPoint = Vector2.new(1, 0.5), BackgroundTransparency = 1, Position = UDim2.new(1, -49, 0.5, 0), Size = UDim2.new(1, -InitialLeftWidth - 57 - 1, 1, -16), Parent = TopBar })
    ...
    CurrentTabLabel = New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.fromScale(1, 0), AutomaticSize = Enum.AutomaticSize.Y, Text = "", TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, Parent = CurrentTabInfo })
    CurrentTabDescription = New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.fromScale(1, 0), AutomaticSize = Enum.AutomaticSize.Y, Text = "", TextWrapped = true, TextSize = 14, TextXAlignment = Enum.TextXAlignment.Left, TextTransparency = 0.5, Parent = CurrentTabInfo })
    SearchBox = New("TextBox", { BackgroundColor3 = "MainColor", PlaceholderText = "Search", Size = WindowInfo.SearchbarSize, TextScaled = true, Visible = not (WindowInfo.DisableSearch or false), Parent = RightWrapper })
    ...
    if SearchIcon then
        New("ImageLabel", { Image = SearchIcon.Url, ImageColor3 = "FontColor", ImageRectOffset = SearchIcon.ImageRectOffset, ImageRectSize = SearchIcon.ImageRectSize, ImageTransparency = 0.5, Size = UDim2.fromScale(1, 1), SizeConstraint = Enum.SizeConstraint.RelativeYY, Parent = SearchBox })
    end
    if MoveIcon then
        New("ImageLabel", { AnchorPoint = Vector2.new(1, 0.5), Image = MoveIcon.Url, ImageColor3 = "OutlineColor", ImageRectOffset = MoveIcon.ImageRectOffset, ImageRectSize = MoveIcon.ImageRectSize, Position = UDim2.new(1, -10, 0.5, 0), Size = UDim2.fromOffset(28, 28), SizeConstraint = Enum.SizeConstraint.RelativeYY, Parent = TopBar })
    end
    BottomBackground = New("Frame", { AnchorPoint = Vector2.new(0, 1), BackgroundColor3 = function() return Library:GetBetterColor(Library.Scheme.BackgroundColor, 4) end, Position = UDim2.fromScale(0, 1), Size = UDim2.new(1, 0, 0, 20 + WindowInfo.CornerRadius), Parent = MainFrame })
    ...
    table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, WindowInfo.CornerRadius), Parent = BottomBackground }))
    FooterLabel = New("TextLabel", { BackgroundTransparency = 1, Size = UDim2.fromScale(1, 1), Text = WindowInfo.Footer, TextSize = 14, TextTransparency = 0.5, Parent = BottomBar })
    ...
    New("ImageLabel", {
        ...
        ImageTransparency = 0.5, Position = UDim2.fromOffset(2, 2),
        Size = UDim2.new(1, -4, 1, -4), Parent = ResizeButton,
    })
    Tabs = New("ScrollingFrame", { AutomaticCanvasSize = Enum.AutomaticSize.Y, BackgroundColor3 = "BackgroundColor", CanvasSize = UDim2.fromScale(0, 0), Position = UDim2.fromOffset(0, 49), ScrollBarThickness = 0, Size = UDim2.new(0, InitialLeftWidth, 1, -70), Parent = MainFrame })
    New("UIListLayout", { Parent = Tabs })
    Container = New("Frame", { AnchorPoint = Vector2.new(1, 0), BackgroundColor3 = function() return Library:GetBetterColor(Library.Scheme.BackgroundColor, 1) end, Name = "Container", Position = UDim2.new(1, 0, 0, 49), Size = UDim2.new(1, -InitialLeftWidth - 1, 1, -70), Parent = MainFrame })
...
function Window:ChangeTitle(title) WindowTitle.Text = title; WindowInfo.Title = title end
if WindowInfo.BackgroundImage then
    function Window:SetBackgroundImage(Image) BackgroundImage.Image = Image; WindowInfo.BackgroundImage = Image end
end
function Window:SetFooter(footer) FooterLabel.Text = footer; WindowInfo.Footer = footer end
function Window:SetCornerRadius(Radius)
    Radius = math.min(Radius, 20)
    for _, UICorner in Library.Corners do
        if UICorner.CornerRadius.Offset == Library.CornerRadius / 2 then UICorner.CornerRadius = UDim.new(0, Radius / 2)
        else UICorner.CornerRadius = UDim.new(0, Radius) end
    end
    Library.CornerRadius = Radius; WindowInfo.CornerRadius = Radius
...
function Window:ShowTabInfo(Name, Description)
    CurrentTabLabel.Text = Name; CurrentTabDescription.Text = Description
...
function Window:AddTab(...)
    ...
    if select("#", ...) == 1 and typeof(...) == "table" then
        local Info = select(1, ...); Name = Info.Name or "Tab"; Icon = Info.Icon; Description = Info.Description
    ...
    do
        TabButton = New("TextButton", { BackgroundColor3 = "MainColor", BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 40), Text = "", Parent = Tabs })
        ...
        TabLabel = New("TextLabel", { BackgroundTransparency = 1, Position = UDim2.fromOffset(30, 0), Size = UDim2.new(1, -30, 1, 0), Text = Name, TextSize = 16, TextTransparency = 0.5, TextXAlignment = Enum.TextXAlignment.Left, Visible = not IsCompact, Parent = TabButton })
        if Icon then
        ...
        TabLeft = New("ScrollingFrame", { AutomaticCanvasSize = Enum.AutomaticSize.Y, BackgroundTransparency = 1, CanvasSize = UDim2.fromScale(0, 0), ScrollBarImageTransparency = 1, ScrollBarThickness = 0, Size = UDim2.new(0.5, -3, 1, 0), Parent = TabContainer })
        ...
        New("Frame", { BackgroundTransparency = 1, LayoutOrder = 1, Parent = TabLeft })
        TabRight = New("ScrollingFrame", { AnchorPoint = Vector2.new(1, 0), AutomaticCanvasSize = Enum.AutomaticSize.Y, BackgroundTransparency = 1, CanvasSize = UDim2.fromScale(0, 0), Position = UDim2.fromScale(1, 0), ScrollBarImageTransparency = 1, ScrollBarThickness = 0, Size = UDim2.new(0.5, -3, 1, 0), Parent = TabContainer })
    ...
    local Tab = {
        Groupboxes = {}, Tabboxes = {}, DependencyGroupboxes = {},
    ...
    function Tab:RefreshSides()
        for _, Side in Tab.Sides do
            Side.Position = UDim2.new(Side.Position.X.Scale, 0, 0, 0)
            Side.Size = UDim2.new(0.5, -3, 1, 0)
        end
    end
    function Tab:Resize(ResizeWarningBox) Tab:RefreshSides() end

    function Tab:AddGroupbox(Info2)
        local BoxHolder = New("Frame", { AutomaticSize = Enum.AutomaticSize.Y, BackgroundTransparency = 1, Size = UDim2.fromScale(1, 0), Parent = Info2.Side == 1 and TabLeft or TabRight })
        ...
        local GroupboxHolder = New("Frame", { BackgroundColor3 = "BackgroundColor", Size = UDim2.fromScale(1, 0), Parent = BoxHolder })
        ...
        local BoxIcon = Library:GetCustomIcon(Info2.IconName)
        if BoxIcon then
            New("ImageLabel", { Image = BoxIcon.Url, ImageColor3 = BoxIcon.Custom and "WhiteColor" or "AccentColor", ImageRectOffset = BoxIcon.ImageRectOffset, ImageRectSize = BoxIcon.ImageRectSize, Position = UDim2.fromOffset(6, 6), Size = UDim2.fromOffset(22, 22), Parent = GroupboxHolder })
        end
        local GroupboxLabel = New("TextLabel", { BackgroundTransparency = 1, Position = UDim2.fromOffset(BoxIcon and 24 or 0, 0), Size = UDim2.new(1, 0, 0, 34), Text = Info2.Name, TextSize = 15, TextXAlignment = Enum.TextXAlignment.Left, Parent = GroupboxHolder })
        New("UIPadding", { PaddingLeft = UDim.new(0, 12), PaddingRight = UDim.new(0, 12), Parent = GroupboxLabel })
        local GroupboxContainer = New("Frame", { BackgroundTransparency = 1, Position = UDim2.fromOffset(0, 35), Size = UDim2.new(1, 0, 1, -35), Parent = GroupboxHolder })
        ...
        function Groupbox:Resize() GroupboxHolder.Size = UDim2.new(1, 0, 0, (GroupboxList.AbsoluteContentSize.Y / Library.DPIScale) + 49) end
        setmetatable(Groupbox, BaseGroupbox)
        Groupbox:Resize(); Tab.Groupboxes[Info2.Name] = Groupbox
        return Groupbox
    end

    function Tab:AddLeftGroupbox(Name2, IconName) return Tab:AddGroupbox({ Side = 1, Name = Name2, IconName = IconName }) end
    function Tab:AddRightGroupbox(Name2, IconName) return Tab:AddGroupbox({ Side = 2, Name = Name2, IconName = IconName }) end

    function Tab:AddTabbox(Info2)
        local BoxHolder = New("Frame", { AutomaticSize = Enum.AutomaticSize.Y, BackgroundTransparency = 1, Size = UDim2.fromScale(1, 0), Parent = Info2.Side == 1 and TabLeft or TabRight })
        New("UIListLayout", { Padding = UDim.new(0, 6), Parent = BoxHolder })
        New("UIPadding", { PaddingBottom = UDim.new(0, 4), PaddingTop = UDim.new(0, 4), Parent = BoxHolder })
        local TabboxHolder = New("Frame", { BackgroundColor3 = "BackgroundColor", Size = UDim2.fromScale(1, 0), Parent = BoxHolder })
        ...
        local TabboxButtons = New("Frame", { BackgroundTransparency = 1, Size = UDim2.new(1, 0, 0, 34), Parent = TabboxHolder })
        ...
        function Tabbox:UpdateCorners()
            for _, SubTab in Tabbox.Tabs do SubTab:UpdateCorners() end
        end
        function Tabbox:AddTab(TabName, IconName)
            local TabIndex = TotalTabs; TotalButtons += 1; TotalTabs += 1
            local BoxIcon2 = Library:GetCustomIcon(IconName)
            ...
            local ButtonIcon
            if BoxIcon2 then
                ButtonIcon = New("ImageLabel", { Image = BoxIcon2.Url, ImageColor3 = BoxIcon2.Custom and "WhiteColor" or "AccentColor", ImageRectOffset = BoxIcon2.ImageRectOffset, ImageRectSize = BoxIcon2.ImageRectSize, ImageTransparency = 0.5, Size = UDim2.fromOffset(16, 16), Parent = ButtonContent })
            end
            local ButtonLabel = New("TextLabel", { AutomaticSize = Enum.AutomaticSize.X, BackgroundTransparency = 1, Size = UDim2.fromOffset(0, 16), Text = TabName, TextSize = 15, TextTransparency = 0.5, Parent = ButtonContent })
            local Line = Library:MakeLine(Button, { AnchorPoint = Vector2.new(0, 1), Position = UDim2.new(0, 0, 1, 1), Size = UDim2.new(1, 0, 0, 1) })
            local SubContainer = New("Frame", { BackgroundTransparency = 1, Position = UDim2.fromOffset(0, 35), Size = UDim2.new(1, 0, 1, -35), Visible = false, Parent = TabboxHolder })
            local SubList = New("UIListLayout", { Padding = UDim.new(0, 8), Parent = SubContainer })
            New("UIPadding", { PaddingBottom = UDim.new(0, 7), PaddingLeft = UDim.new(0, 7), PaddingRight = UDim.new(0, 7), PaddingTop = UDim.new(0, 7), Parent = SubContainer })
            local SubTab = { ButtonHolder = Button, Container = SubContainer, ButtonCovers = { BottomCover = BottomCover, LeftCover = LeftCover, RightCover = RightCover }, Tab = Tab, Elements = {}, DependencyBoxes = {} }
            function SubTab:Show()
                if Tabbox.ActiveTab then Tabbox.ActiveTab:Hide() end
                Button.BackgroundTransparency = 1; BottomCover.BackgroundTransparency = 1
                LeftCover.BackgroundTransparency = 1; RightCover.BackgroundTransparency = 1
                ButtonLabel.TextTransparency = 0
                if ButtonIcon then ButtonIcon.ImageTransparency = 0 end
                Line.Visible = false; SubContainer.Visible = true
                Tabbox.ActiveTab = SubTab; SubTab:Resize()
            end
            function SubTab:Hide()
                Button.BackgroundTransparency = 0; BottomCover.BackgroundTransparency = 0
                LeftCover.BackgroundTransparency = 0; RightCover.BackgroundTransparency = 0
                ButtonLabel.TextTransparency = 0.5
                if ButtonIcon then ButtonIcon.ImageTransparency = 0.5 end
                Line.Visible = true; SubContainer.Visible = false; Tabbox.ActiveTab = nil
            end
            function SubTab:Resize()
                if Tabbox.ActiveTab ~= SubTab then return end
                TabboxHolder.Size = UDim2.new(1, 0, 0, (SubList.AbsoluteContentSize.Y / Library.DPIScale) + 49)
            end
            function SubTab:UpdateCorners()
                LeftCover.Visible = TabIndex ~= 1; RightCover.Visible = TabIndex ~= TotalButtons
            ...
            Tabbox.Tabs[TabName] = SubTab; Tabbox:UpdateCorners()
            return SubTab
        end
        if Info2.Name then Tab.Tabboxes[Info2.Name] = Tabbox else table.insert(Tab.Tabboxes, Tabbox) end
        return Tabbox
    end

    function Tab:AddLeftTabbox(Name2) return Tab:AddTabbox({ Side = 1, Name = Name2 }) end
    function Tab:AddRightTabbox(Name2) return Tab:AddTabbox({ Side = 2, Name = Name2 }) end
    ...
    function Tab:Show()
        ...
        TabContainer.Visible = true; Tab:RefreshSides(); Library.ActiveTab = Tab
        if Library.Searching then Library:UpdateSearch(Library.SearchText) end
    end
    function Tab:Hide()
        ...
        TabContainer.Visible = false; Window:HideTabInfo(); Library.ActiveTab = nil
    end
    ...
    if Library.Toggled and not Library.IsMobile then
        ...
        RunService:BindToRenderStep(ShowCursorBinding, Enum.RenderPriority.Last.Value, function()
            ...
            if not (Library.Toggled and ScreenGui and ScreenGui.Parent) then
                ...
                Cursor.Visible = false; RunService:UnbindFromRenderStep(ShowCursorBinding)
            end
        end)
...
function Library:Toggle(Value) return Window:Toggle(Value) end
...
if Library.IsMobile then
    ...
    if WindowInfo.MobileButtonsSide == "Right" then
        ToggleButton.Button.Position = UDim2.new(1, -6, 0, 6); ToggleButton.Button.AnchorPoint = Vector2.new(1, 0)
        LockButton.Button.Position = UDim2.new(1, -6, 0, 46); LockButton.Button.AnchorPoint = Vector2.new(1, 0)
    else LockButton.Button.Position = UDim2.fromOffset(6, 46) end
    if WindowInfo.ShowMobileButtons == false then
        ToggleButton.Button.Visible = false; LockButton.Button.Visible = false
    end
end
...
Library:GiveSignal(UserInputService.InputBegan:Connect(function(Input)
    ...
    if (typeof(Library.ToggleKeybind) == "table" and Library.ToggleKeybind.Type == "KeyPicker" and Input.KeyCode.Name == Library.ToggleKeybind.Value)
