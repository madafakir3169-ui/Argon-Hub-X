...
local Icons = (function()
    local SHEET = "rbxassetid://75871650250968"
    local S = 24
    local icons = {
        ["home"]     = {x=0,   y=0},
        ["swords"]   = {x=1,   y=0},
        ...
        ["check"]              = {x=6,  y=0},
        ["chevron-up"]         = {x=7,  y=0},
        ["move-diagonal-2"]    = {x=8,  y=0},
        ["key"]                = {x=9,  y=0},
        ["move"]               = {x=10, y=0},
        ["file-question-mark"] = {x=11, y=0},
    }
    return {
        GetAsset = function(name)
            ...
            return {
                Url = SHEET,
                ImageRectOffset = Vector2.new(d.x * S, d.y * S),
                ImageRectSize = Vector2.new(S, S),
                Custom = false,
            }
        end
    }
